package com.firemans.web.course.config;
...
import com.firemans.web.course.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order o2 = new Order(null, Instant.parse("2019-07-20T19:53:17Z"), OrderStatus.WAITING_PAYMENT, u2);
		Order o3 = new Order(null, Instant.parse("2019-08-20T19:53:22Z"), OrderStatus.WAITING_PAYMENT, u1);
